...
const teamMembers = [{
  name: 'Jahirul Shifat',
  role: 'Founder & CEO',
  imageUrl: 'https://i.ibb.co.com/0V2wDwN2/photo-2025-02-05-12-04-07.jpg'
}, {
  name: 'Emily Jonson',
  role: 'CEO',
...
const TeamMemberCard = ({
  member
    ...
    <img className="w-32 h-32 md:w-36 md:h-36 rounded-2xl object-cover shadow-lg " src={member.imageUrl} alt={`Portrait of ${member.name}`} onError={e => {
